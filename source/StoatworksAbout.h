/*
 * Stoatworks Labs - About window data for Cartridge.
 *
 * GENERATED by stoatworks-backend/scripts/sync-about.py on 2026-09-05. Do not
...
{
    inline constexpr auto name = "Cartridge";
    inline constexpr auto slug = "cartridge";
    inline constexpr auto hook = "A console emulator as a live Resolume source";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/cartridge/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/cartridge/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/cartridge";
